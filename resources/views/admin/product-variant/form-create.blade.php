                    ...
                    <div class="form">
                        <form class="cmxform form-horizontal" id="" method="post"
                            ...
                            <div class="form-group">
                                <label for="color" class="control-label col-lg-12">Màu sắc <span
                            ...
                            <div class="form-group">
                                <label for="remain_quantity" class="control-label col-lg-12">Số lượng nhập <span
                                        style="color: red">*</span></label>
                                <div class="col-lg-9">
                                    <input class="form-control" id="remain_quantity" name="remain_quantity" type="number"
                                        min="0" value="{{ old('remain_quantity') }}" required>
